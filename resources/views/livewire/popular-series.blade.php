<div class="flex flex-col my-7">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-xl text-sky-300 font-bold uppercase mx-4 ">Most Popular</h2>
        <a href="{{route('tvCategory','popular')}}"><x-button class="btn-primary">View More</x-button></a>
    </div>

    <div class="mt-8 grid grid-cols-6  gap-10 popular-slide relative">
